...
Usage
Here is the default link : https://localhost:8443/entity-import/control/main There is a form which accepts a file in XML or XLS format. You can download samples here :sample files in XLS and XML